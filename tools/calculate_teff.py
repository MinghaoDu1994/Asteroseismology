...
#Calling Method:
    ...
    #           Using Cal_teff(B_band,V_band,None,stellar_type)
    # Choice2: If you just have B-V band values 
    #           Using Cal_teff(None,None,B_V_band,stellar_type)
#
...
def bv_to_teff(B_band = None ,V_band = None ,B_V_band = None, stellar_type = None):
    if B_V_band is None:
